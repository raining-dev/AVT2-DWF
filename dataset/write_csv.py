...
parser.add_argument('--out_dir',type=str, default='/data/DeepfakeTIMIT/train', help='Output direcotry');
opt = parser.parse_args();

# setattr(opt,'real_dir_test',os.path.join(opt.out_dir,'test','pytmp','real'))
setattr(opt,'fake_dir_test',os.path.join(opt.out_dir,'fake_higher'))
# setattr(opt,'real_dir_train',os.path.join(opt.out_dir,'train','pytmp','real'))
setattr(opt,'fake_dir_train',os.path.join(opt.out_dir,'fake_lower'))
...
write_list(train_set, os.path.join(opt.csv_root, 'all_lower_split.csv'))
write_list(test_set, os.path.join(opt.csv_root, 'all_higher_split.csv'))